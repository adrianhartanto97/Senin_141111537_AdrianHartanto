...
{
    public partial class FormSettingEditor : Form
    {
        public FormSettingEditor()
        {
            InitializeComponent();
            panel1.Visible = false;
        }

        private void FormSettingEditor_Load(object sender, EventArgs e)
        {
            ...
            this.comboBox1.Text = frm.getBackgroundColor();
        }
        ...
        {
            Form1 frm = (Form1)MdiParent;
            frm.setBackgroundColor(comboBox1.Text);
            frm.showRTB();
            this.Close();
        }
